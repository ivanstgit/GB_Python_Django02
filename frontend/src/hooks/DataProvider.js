...
const DataProvider = (props) => {
    ...
    const refresh = (resource) => {
        ...
        if (resource === DATA_RESOURCES.projects) {
            callback = setProjects
        }
        if (resource === DATA_RESOURCES.todos) {
            callback = setToDos
        }
    ...
    useEffect(() => {
        ...
        refresh(DATA_RESOURCES.projects)
        refresh(DATA_RESOURCES.todos)
    ...
    return (
        ...
        // getList 
        <DataContext.Provider value={{ users, projects, todos, refreshDelayed, postOne, deleteOne }}>
            {props.children}
